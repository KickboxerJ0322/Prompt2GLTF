...
// ── New createPreviewHtml using UMD Three.js (works with file:// and http://) ─
// All non-ASCII characters are expressed as JS/HTML escape sequences to avoid
// encoding issues when the file is saved and read back.
